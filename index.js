...
// Make sure all environment variables are properly loaded
...
// Set up commands menu - All commands are lowercase
try {
  bot
    .setMyCommands([
...
bot.onText(/\/start/, async (msg) => {
  ...
  // Updated welcome message with links to Telegram chat and X (Twitter)
  const welcomeMessage = `Welcome to CORESIGHT🔭! your gateway to deep insight and analysis using blockchain data!

Join the CORESIGHT CHAT to learn how to get access to the bot: https://t.me/+lkCgenv5w-1kZDQ0

Follow us on X for more info and updates: https://x.com/coresightbot
...
// EVM Cabal command handler - LOWERCASE version
